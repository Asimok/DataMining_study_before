...
with open('/home/asimov/PycharmProjects/DataMining/MQ/深度学习/NLP/data/stoplist.txt', 'r') as f:
    stop_words = f.read()  # 获取停顿词
f.close()
stop_words = ['  ', '', '\n', '\t'] + stop_words.split()  # 改为列表 并且扩充一部分停顿词
data = pd.read_excel('/home/asimov/PycharmProjects/DataMining/MQ/深度学习/NLP/data/训练集.xlsx')
